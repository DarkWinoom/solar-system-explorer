...
**[Adrift Among Infinite Stars](https://www.scottbuckley.com.au/library/adrift-among-infinite-stars/)** by Scott Buckley, published February 19, 2022.

'Adrift Among Infinite Stars' by Scott Buckley - released under CC-BY 4.0. www.scottbuckley.com.au

License: [Creative Commons Attribution 4.0 International](https://creativecommons.org/licenses/by/4.0/).
The full recording is re-encoded as `public/audio/adrift-among-infinite-stars.mp3` for web delivery.
The composition and duration are unchanged; playback loops and uses the listener's volume setting.
The application credits the title, artist and license in its audio panel. This does not imply endorsement.
...
The decorative star field, procedural galaxy and dust lanes, interface graphics, and corona gradient are generated by application code. They are not a catalog of measured stars.
